  ...
  myHaskellPackageOverlay = self: super: {
    ...
    myHaskellPackages = super.haskellPackages.override {
      overrides = hself: hsuper: rec {
        ...
        random-fu = self.haskell.lib.addBuildDepends
          (super.haskell.lib.dontHaddock (super.haskell.lib.dontCheck (
            hself.callCabal2nixWithOptions "random-fu"
              (builtins.fetchGit {
        ...
        rvar = self.haskell.lib.addBuildDepends
          (super.haskell.lib.dontHaddock (super.haskell.lib.dontCheck (
            hself.callCabal2nixWithOptions "rvar"
              (builtins.fetchGit {
                url = "https://github.com/lehins/random-fu";
                rev = "1eb5c0080618a691cd9fa81ac3d0ea29edeb084f";
                ref = "switch-to-random";
