...
import Control.Monad.Bayes.Class (MonadInfer, MonadSample (uniformD), factor)
...
-- truthfulAgent :: MonadSample m => State -> m Action
...
-- listener :: MonadInfer m => Action -> m State
...
-- informativeAgent :: MonadInfer m => State -> m Action
