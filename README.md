...
[See the docs](https://monad-bayes-site.netlify.app/_site/about.html) for a user guide, notebook-style tutorials, an example gallery, and a detailed account of the implementation.
